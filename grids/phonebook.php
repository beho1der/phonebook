<?php
class phonebook extends jqGrid
{
...
$this->options = array('autowidth'=> true,'sortname'  => 'name', 'sortorder' => 'asc');
        ...
        $this->cols = array(
            ...
            'organization'    => array('label' => 'Организация',
				   ...
				   'stype' => 'select',
				   'editoptions' =>  array('value'=> new jqGrid_Data_Value(array("ЧЗСМ" => "ЧЗСМ", "Инструмент-Груп" => "Инструмент-Груп", "Сити-Недвижимость" => "Сити-Недвижимость", "МСЦ" => "МСЦ", "СПС" => "СПС", "Речелстрой" => "Речелстрой", "УК ДСС" => "УК ДСС", "Дивизион" => "Дивизион", "ЧЭЗ" => "ЧЭЗ","ЧГК" => "ЧГК","СМК" => "СМК","Интегро М" => "Интегро М","УПТК" => "УПТК","ИП Емец Д. С" => "ИП Емец Д. С","УСП" => "УСП","СЭУ-9" => "СЭУ-9"))),
				   'edittype'  => 'select',	
				   'searchoptions' => array(
...
if (($r['number'] == "0") || ($r['number'] == "")) $r['number'] = 'Нет';
